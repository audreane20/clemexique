...
class ExcursionModel
{
    ...
    {
        $stmt = $this->pdo->prepare(
            'INSERT INTO excursions (category_id, name, address, note, website_url, website_label, video_url, sort_order)
    ...
    {
        $stmt = $this->pdo->prepare(
            'SELECT * FROM excursions WHERE category_id = :category_id ORDER BY sort_order ASC, id ASC'
        );
        $stmt->execute([
            'category_id' => $categoryId,
        ]);
    ...
    {
        $stmt = $this->pdo->prepare(
            'UPDATE excursion_categories SET sort_order = :sort_order WHERE id = :id'
        );
    ...
    {
        $stmt = $this->pdo->prepare(
            'UPDATE excursions SET sort_order = :sort_order WHERE id = :id'
        );
    ...
    {
        $stmt = $this->pdo->prepare('SELECT COUNT(*) FROM excursions WHERE category_id = :category_id');
        $stmt->execute([
            'category_id' => $categoryId,
        ]);
